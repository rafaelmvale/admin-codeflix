...
implements IRepository<E, EntityId> {
    ...
    async insert(entity: E extends Entity ? any : any): Promise<any> {
        this.items.push(entity);
    }
    async bulkInsert(entities: (E extends Entity ? any : any)[]): Promise<any> {
    ...
    async findAll(): Promise<(E extends Entity ? any : any)[]> {
        return this.items;
    }
